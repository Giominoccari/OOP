...
class UseConstructors {
    ...
    public static void main(final String[] args) {
        ...
        Student franco = new Student("Luca", "Verdi", 1020, 2013);
        franco.printStudentInfo();
        Train primo = new Train(300, 100, 200);
        primo.printTrainInfo();
        Train secondo = new Train(1200, 50,1050);
        secondo.printTrainInfo();
        Train terzo = new Train(500, 0, 500);
        terzo.printTrainInfo();
        Train quarto = new Train();
        quarto.printTrainInfo();
    }
}
